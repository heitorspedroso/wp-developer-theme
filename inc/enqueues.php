...
function wp_developer_theme_styles(){
    ...
    wp_enqueue_style( 'styles-bxslider',  get_template_directory_uri() . '/css/jquerybxslider.css');
...
function wp_developer_theme_scripts(){
    ...
    wp_enqueue_script('bxslider', get_template_directory_uri() . '/js/jquerybxslider.js', '', '',true);
